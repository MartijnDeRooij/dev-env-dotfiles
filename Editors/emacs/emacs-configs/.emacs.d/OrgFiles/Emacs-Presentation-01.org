...
org-tree-slide can be used for presentations instead of powerpoint. 

;; https://github.com/takaxp/org-tree-slide
(use-package org-tree-slide
  :custom
  (org-image-actual-width nil)) ;;(Not try to set widt of image inside presentation)
...
#+ATTR_HTML: :width 500 ;; Used if image to big. 
